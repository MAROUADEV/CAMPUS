				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">Vous n'avez pas de compte ? Inscrivez-vous <a href="register.php?r=<?php echo $r; ?>">Ici</a> </p>
							<hr>
                      ...
                      if(isset($_GET['cnx']))
                      {
                       ?>
                        ...
                        <strong>Bienvenue !</strong> Si vous avez pas un compte cliquez sur <a href='register.php?r=<?php echo $r; ?>'>inscrire </a> ou vous <a href='login.php?r=<?php echo $r; ?>'>connecter</a> si vous avez un compte. </div>
