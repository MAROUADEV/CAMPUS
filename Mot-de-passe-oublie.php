...
if($user->is_logged_in()!="")
{
 ...
 $user->redirect('../clicCampus/espace-etudiant.php?r=etd');
}
...
if(isset($_POST['btn-submit']))
{
 ...
 if($stmt->rowCount() == 1)
 {
  ...
  $message= "
       ...
       <br /><br />
       <a href='http://127.0.0.1/clicCampus/reinitialisation-du-mot-de-passe.php?IdUtilisateur=$IdUtilisateur&code=$code'>Cliquez ici </a>
       <br /><br />
       Merci :)
       ";
