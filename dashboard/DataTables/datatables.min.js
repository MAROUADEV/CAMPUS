 ...
 *   https://datatables.net/download/#bs4-4.1.1/jqc-1.12.4/dt-1.10.18/af-2.3.2/cr-1.5.0/fc-3.2.5/fh-3.1.4/kt-2.5.0/r-2.2.2/rg-1.1.0/rr-1.2.4/sc-1.5.0/sl-1.2.6
 *
 * Included libraries:
 *   Bootstrap 4 4.1.1, jQuery 1 1.12.4, DataTables 1.10.18, AutoFill 2.3.2, ColReorder 1.5.0, FixedColumns 3.2.5, FixedHeader 3.1.4, KeyTable 2.5.0, Responsive 2.2.2, RowGroup 1.1.0, RowReorder 1.2.4, Scroller 1.5.0, Select 1.2.6
 */
...
d[c]=e,"o"===b[1]&&Z(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Z(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Ca(a){var b=n.defaults.oLanguage,c=b.sDecimal;c&&Da(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&(d&&"Aucune donnée trouvée"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(d&&"Loading..."===b.sLoadingRecords)&&F(a,
...
e)},sName:"pagination"}));return b}function Ta(a,b,c){var d=a._iDisplayStart,e=a._iDisplayLength,f=a.fnRecordsDisplay();0===f||-1===e?d=0:"number"===typeof b?(d=b*e,d>f&&(d=0)):"first"==b?d=0:"<<"==b?(d=0<=e?d-e:0,0>d&&(d=0)):">>"==b?d+e<f&&(d+=e):"last"==b?d=Math.floor((f-1)/e)*e:K(a,0,"Unknown paging action: "+b,5);b=a._iDisplayStart!==d;a._iDisplayStart=d;b&&(r(a,null,"page",[a]),c&&P(a));return b}function qb(a){return h("<div/>",{id:!a.aanFeatures.r?a.sTableId+"_processing":null,"class":a.oClasses.sProcessing}).html(a.oLanguage.sProcessing).insertBefore(a.nTable)[0]}
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:">>",sPrevious:"<<"},sEmptyTable:"Aucune donnée disponible",sInfo:"_START_ to _END_ / _TOTAL_ enregistrements",sInfoEmpty:" 0 / 0 enregistrements",sInfoFiltered:"(filtered from _MAX_ total enregistrements)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:" _MENU_ enregistrements",sLoadingRecords:"Chargement...",sProcessing:"Traitement en cours...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucune donnée trouvée"},oSearch:h.extend({},
