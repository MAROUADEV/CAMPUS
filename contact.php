			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="contact_info">
						<div class="section_title">Prenez contact avec nous</div>
				...
				<div class="col-lg-8">
					<div class="contact_form_container">
						<form action="#" class="contact_form" id="contact_form">
							...
							<div><input type="text" class="contact_input" placeholder="Sujet"></div>
							<div><textarea class="contact_textarea contact_input" placeholder="Message" required="required"></textarea></div>
							<button class="contact_button button">Envoyer</button>
						</form>
					</div>
				</div>
			</div>
