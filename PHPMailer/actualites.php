				  ...
				  <tbody>
					...
					<a href="actualite.php?id=<!--?php echo $res['Id_article'] ?>" style="font-size:15px;" >
                                ...
                                <div class="thumbnail row">
					               ...
					               <h3> <a href="actualite.php?id=<?php echo base64_encode($res['Id_article']) ?>"><?php echo $res['Titre'] ?> </a></h3>
                                ...
                                <div class=" col-sm-4 col-md-4">
                                    ...
                                    <a class=" btn btn-action" href="actualite.php?id=<?php echo base64_encode($res['Id_article']) ?>">Lire la suite</a>
				                </div>
                            </div>
