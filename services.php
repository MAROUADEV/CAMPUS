...
$ville=$_GET['ville'];
$sqlbiens = "SELECT * FROM `biens` order by id_bien DESC limit 5";
	try {
...
$sqlcount = "SELECT COUNT(*) as count FROM `biens` order by id_bien DESC limit 5";
	try {
		...
		<div class="container">
			<div class="row">
				<div class="col">
                    ...
                    if ($res['count'] <=0) {?>
                    <div class="section_title">Aucune donnée trouvée</div>
                    <?php } else if($res['count'] ==1) {?>
					<div class="section_title"><?php echo $res['count'];?> Propriété trouvée</div>
                    <?php } else {?>
                    <div class="section_title"><?php echo $res['count'];?> Propriétés trouvées</div>
                    <?php } }?>
				</div>
			</div>
                ...
                <?php foreach($results3 as $res3) {?>
					...
					<div class="property">
						<div class="property_image">
							<img src="dashboard/uploads/<?php echo $res3['photo'];?>" alt="" style="width:690px;height:350px;">
